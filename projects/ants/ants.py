...
class Ant(Insect):
    ...
    def __init__(self, armor=1):
        ...
        Insect.__init__(self, armor)    # In order to call the attribute of Insect class, eg. Insect.ant
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place.entrance != None or place != hive:
            if len(place.bees) > 0 and offset >= self.min_range and offset <= self.max_range:
...
class ScubaThrower(ThrowerAnt):
    """
    One type of ThrowerAnt that can be placed in a water place.
    """
    name = 'Scuba'
    food_cost = 6
    implemented = True
...
class HungryAnt(Ant):
    ...
    def __init__(self):
        # BEGIN Problem 6
        Ant.__init__(self)    # because redefine __init__, in order to use attribute in orginal Ant class, add this line
        self.digesting = 0
        # END Problem 6
